...
namespace Snake2._0.Assets
{
    public class SnakeAssets
    {
        ...
        public char SnakeHead { get; set; } = Encoding.GetEncoding(437).GetChars(new byte[] { 219 })[0];
        public char Meal { get; set; } = Encoding.GetEncoding(437).GetChars(new byte[] { 177 })[0];
        public char Boundary { get; set; } = Encoding.GetEncoding(437).GetChars(new byte[] { 178 })[0];
